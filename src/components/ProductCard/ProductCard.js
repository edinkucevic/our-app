...
export default function ProductCard({ image, title, price, onClick }) {
  return (
    <div className="bg-black-100 w-full min-h-screen gap-4 flex-wrap flex justify-center items-center">
      <div className="w-60 px-6 bg-white rounded py-6 transform transition-all hover:translate-y-2">
        ...
        <div className="flex justify-between ">
          <button
            onClick={onClick}
            className="bg-red-400 px-4 py-1 h-30 w-30 hover:bg-green-600 text-white rounded mt-3 ml-1 "
          >
            Add to cart
          </button>
